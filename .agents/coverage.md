...
7. **Write artifact** to `$TERMINAL_REPORTS_DIR/coverage/<short_sha>.md`.
...
`$TERMINAL_REPORTS_DIR/coverage/<short_sha>.md`:
...
flakes_detected: 2
tickets_filed: [$TERMINAL_BACKLOG_DIR/0125-flake-mr-checker.md]
status: ok
---
```
