        ...
        <Section icon={SquareTerminal} title="Around the app">
          <div className="space-y-1.5 text-[12px] leading-snug text-zinc-400">
            <p>
              ...
              live event feed; Notes / Files / Sessions round it out. Search and Inbox live in the top-right utilities.
            </p>
            <p>
            ...
            <p>
              ...
              <code className="font-mono">Cmd/Ctrl+K</code> opens the command palette;{' '}
