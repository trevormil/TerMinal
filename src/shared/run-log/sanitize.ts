// Sanitize raw PTY / CI log output for display or parsing.
// (Moved from src/renderer/src/lib/sanitizeLog.ts so the shared run-log parser
// can use it; the renderer lib re-exports from here.)
//
// What gets cleaned:
