...
- **Open tickets** (big): `${CLAUDE_PLUGIN_ROOT}/skills/ticket/bin/tickets open 2>/dev/null | tail -n +3 | wc -l | tr -d ' '`
...
- **Active session** (text): `${CLAUDE_PLUGIN_ROOT}/skills/session-start/bin/sessions active 2>/dev/null | tail -n +3`
